...
class Connector:
    ...
    def from_dict(cls, data: dict) -> "Connector":
        ...
        return cls(
            ...
            total_consumption_kwh=float(data.get("totalConsumptionKwh", 0.0)),
            current1=float(data.get("current1", 0.0)),
            current2=float(data.get("current2", 0.0)),
            current3=float(data.get("current3", 0.0)),
            voltage1=float(data.get("voltage1", 0.0)),
            voltage2=float(data.get("voltage2", 0.0)),
