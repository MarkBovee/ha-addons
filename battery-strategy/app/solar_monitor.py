...
class SolarMonitor:
    def __init__(self, config: Dict[str, Any], logger: logging.Logger):
        self.config = config
        self.logger = logger
        self.solar_entity = config.get("power_production_entity")
        self.net_entity = config.get("power_net_entity")
        
        # Thresholds
        self.entry_threshold = config.get("passive_solar_entry_threshold", 1000)
        self.exit_threshold = config.get("passive_solar_exit_threshold", 200)
